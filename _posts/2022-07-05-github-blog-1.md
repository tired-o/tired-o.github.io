...
확장명을 변경해도 사용할 수 있으니 바꿔주세요. 파일을 실행하면 웹브라우저에 Hello world가 떠있는 걸 볼 수 있습니다.
...
업로드가 바로 될 줄 알았는데, 팝업창이 뜹니다. <kbd>Sign in with your browser</kbd>를 눌러 GitHub에 로그인합니다.
...
## 주석
[^1]: Custom domain을 적용한 경우는 예외지만, 많은 경우 `github.io` 형식을 그대로 사용하므로 이해를 돕고자 위와 같이 표현함