...
<br>**공부법?** 베이스가 있다면 or 전공자라면 기출 위주로, 없다면 통계 개념도 익히기
...
데이터 관련업과 연관이 있으시다면 따놓아서 손해볼 일은 없을 것 같습니다. 다른 데이터자격검정 준전문가 자격증보다는 높은 평가를 받는 것 같고, SQL을 잘 모른다면 준비하면서 공부하는 것 만으로도 도움이 될 것입니다.
